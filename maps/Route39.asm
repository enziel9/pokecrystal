...
Route39FruitTree2:
	fruittree FRUITTREE_ROUTE_39_2

Route39FruitTree3:
	fruittree FRUITTREE_ROUTE_39_3

Route39FruitTree4:
	fruittree FRUITTREE_ROUTE_39_4
...
Route39_MapEvents:
	...
	warp_event  0,  6, VILLAGGIO_INIZIALE, 1
	warp_event  0,  7, VILLAGGIO_INIZIALE, 2
	...
	object_event 13,  5, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route39FruitTree2, -1
	object_event 17, 11, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route39FruitTree3, -1
	object_event 13, 19, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route39FruitTree4, -1
