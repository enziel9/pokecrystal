...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	...
	const FRUITTREE_ROUTE_39_2    ; 1f
	const FRUITTREE_ROUTE_39_3    ; 20
	const FRUITTREE_ROUTE_39_4    ; 21
	const FRUITTREE_VILLAGGIO_1   ; 22
	const FRUITTREE_VILLAGGIO_2   ; 23
	const FRUITTREE_VILLAGGIO_3   ; 24
	const FRUITTREE_VILLAGGIO_4   ; 25
	const FRUITTREE_VILLAGGIO_5   ; 26
