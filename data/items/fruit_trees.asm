...
; entries correspond to FRUITTREE_* constants
	...
	db BERRY        ; ROUTE_39_2
	db PSNCUREBERRY ; ROUTE_39_3
	db PRZCUREBERRY ; ROUTE_39_4
	db BERRY        ; VILLAGGIO_1
	db ICE_BERRY    ; VILLAGGIO_2
	db MYSTERYBERRY ; VILLAGGIO_3
	db BITTER_BERRY ; VILLAGGIO_4
	db PSNCUREBERRY ; VILLAGGIO_5
