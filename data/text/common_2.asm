...
_OakText1::
	text "Il sole e' alto"
	line "sull'allevamento."

	para "Sei seduto vicino"
	line "a una sella."

	para "Hai un coltello."
...
_OakText2::
	text "Le lettere pren-"
	line "dono forma sotto"
	cont "la lama, una alla"
	cont "volta.@"
	text_end
...
_OakText4::
	text "Fuori, un Tauros"
	line "bruca tranquillo."
