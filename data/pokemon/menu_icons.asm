...
MonMenuIcons:
	...
	db ICON_CHARMANDER  ; TREECKO
	db ICON_BIRD        ; TORCHIC
	db ICON_SQUIRTLE    ; MUDKIP
	db ICON_SQUIRTLE    ; TURTWIG
	db ICON_HUMANSHAPE  ; CHIMCHAR
	db ICON_BIRD        ; PIPLUP
	db ICON_SERPENT     ; SNIVY
	db ICON_BLOB        ; TEPIG
	db ICON_SQUIRTLE    ; OSHAWOTT
	db ICON_CHARMANDER  ; GROVYLE
	db ICON_CHARMANDER  ; SCEPTILE
	db ICON_BIRD        ; COMBUSKEN
	db ICON_FIGHTER     ; BLAZIKEN
	db ICON_SQUIRTLE    ; MARSHTOMP
	db ICON_SQUIRTLE    ; SWAMPERT
	db ICON_SQUIRTLE    ; GROTLE
	db ICON_SQUIRTLE    ; TORTERRA
	db ICON_HUMANSHAPE  ; MONFERNO
	db ICON_HUMANSHAPE  ; INFERNAPE
	db ICON_BIRD        ; PRINPLUP
	db ICON_BIRD        ; EMPOLEON
	db ICON_SERPENT     ; SERVINE
	db ICON_SERPENT     ; SERPERIOR
	db ICON_FIGHTER     ; PIGNITE
	db ICON_FIGHTER     ; EMBOAR
	db ICON_SQUIRTLE    ; DEWOTT
	db ICON_SQUIRTLE    ; SAMUROTT
